...
export const PDFEditLayer: React.FC<PDFEditLayerProps> = ({
  ...
  return (
    <div className="w-full h-full flex items-center justify-center bg-muted/10 rounded-lg border border-border">
      <p className="text-muted-foreground text-sm">Editor preview is not available.</p>
    </div>
  );
};
