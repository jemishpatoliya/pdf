...
const Security = () => {
  ...
  const loadSettings = async () => {
    try {
      ...
      safeToast(err.message || "Failed to load security settings");
    } finally {
      setLoading(false);
    }
  };
  ...
  const loadHistory = async (pageNum: number) => {
    try {
      ...
      safeToast(err.message || "Failed to load login history");
    }
  };
  ...
  const handleAddIp = async () => {
    ...
    try {
      ...
      safeToast("IP added to whitelist");
      setNewIp("");
      await loadSettings();
    } catch (err: any) {
      safeToast(err.message || "Failed to add IP");
    }
  };
  ...
  const handleRemoveIp = async (ip: string) => {
    try {
      ...
      safeToast(err.message || "Failed to remove IP");
    }
  };
  ...
  const handleToggleWhitelist = async () => {
    ...
    try {
      ...
      safeToast(err.message || "Failed to toggle IP whitelist");
    }
  };
